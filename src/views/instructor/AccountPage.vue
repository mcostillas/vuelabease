  ...
  <DashboardLayout>
      ...
      <div class="profile-section">
        <div class="profile-header">
          ...
          <div class="profile-info">
            ...
            <p class="role-badge">Instructor</p>
          </div>
        </div>
    ...
    >
      <div class="confirmation-message">
        <svg width="64" height="64" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="warning-icon">
        ...
        <div class="confirmation-actions">
          <button type="button" class="cancel-button" @click="cancelDeleteImage">Cancel</button>
          <button type="button" class="delete-button" @click="deleteProfileImage">Delete</button>
        </div>
      </div>
    </Modal>
  ...
  methods: {
    ...
    deleteProfileImage() {
      try {
        ...
        this.errorMessage = 'Failed to delete profile image';
      }
    },
    handleUpdateProfile() {
